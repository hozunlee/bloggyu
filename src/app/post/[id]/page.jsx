...
export const generateMetadata = async ({ params }) => {
	...
	return {
		...
		keywords: ['장기렌트카', '장기렌트', '세금', '장기리스', '신차 장기렌트'],
		authors: [{ name: 'moon' }, { name: 'moon', url: 'https://www.bloggyu.com' }],
		colorScheme: 'dark',
		creator: 'moon',
		formatDetection: {
			email: false,
		...
		openGraph: {
			...
			images: [
				{
					url: post.attributes.main_cover.data[0].attributes.formats.thumbnail.url,
					width: 800,
					height: 600
				},
				{
		...
		<div className="mx-auto">
			<main className="detail-box">
				...
				<figure>
					...
					<Markdown linkTarget="_blank">{post.attributes.content}</Markdown>
				</figure>
			</main>
		</div>
	)
